...
function Kibixinha() {
  return (
    <div style={{backgroundColor:'#2412c2',padding:'10px',borderRadius:'8px',marginBottom:'10px'}}>
      <h2 style={{color: '#c71a85'}}>Kibixinha, Kibi de Coxinha!</h2>
      <p>Este componente foi criado separadamente.</p>
    </div>
  );
}
...
function Capivara() {
  return (
    <div style={{backgroundColor:'#cbce11',padding:'10px',borderRadius:'8px',marginBottom:'10px'}}>
      <h2 style={{color: '#cc2641'}}>Capivara, o animal mais fofinho!</h2>
      <p>Este componente foi criado separadamente.</p>
    </div>
  );
}
...
<Perfil teste="Luiza" cargo="Desenvolvedor Front-end" />
<Perfil teste="Maria" cargo="Designer Gráfico" />
